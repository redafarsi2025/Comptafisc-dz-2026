...
export const SCF_ACCOUNTS: SCF_Account[] = [
  ...
  { code: '2182', name: 'Matériel de transport (Véhicules)', category: 'Immobilisations', class: 2 },
  ...
  { code: '411', name: 'Clients et comptes rattachés', category: 'Tiers', class: 4, isRoot: true },
  ...
  { code: '6061', name: 'Fournitures non stockables (Eau, Energie, Carburant)', category: 'Charges', class: 6 },
  ...
  { code: '706', name: 'Prestations de services (Transport / Conseil)', category: 'Produits', class: 7 },
];
