...
export const SCF_ACCOUNTS: SCF_Account[] = [
  ...
  // CLASSE 3 : COMPTES DE STOCKS ET EN-COURS (Personnalisation par activité)
  ...
  { code: '3002', name: 'Marchandises - Boissons et liquides', category: 'Stocks', class: 3 },
  { code: '3003', name: 'Marchandises - Produits d\'entretien', category: 'Stocks', class: 3 },
  { code: '31', name: 'Matières premières et fournitures', category: 'Stocks', class: 3, isRoot: true },
  { code: '3101', name: 'Matières premières (Imprimerie - Papier)', category: 'Stocks', class: 3 },
  { code: '3102', name: 'Fournitures consommables (Encre/Solvants)', category: 'Stocks', class: 3 },
  { code: '35', name: 'Stocks de produits', category: 'Stocks', class: 3, isRoot: true },
  { code: '355', name: 'Produits finis', category: 'Stocks', class: 3 },
  ...
  { code: '4111', name: 'Clients - Ventes nationales', category: 'Tiers', class: 4 },
  { code: '4117', name: 'Clients - Retenues de garantie (BTP)', category: 'Tiers', class: 4 },
  ...
  { code: '5121', name: 'Banque - Compte DZD', category: 'Trésorerie', class: 5 },
  { code: '5122', name: 'Banque - Compte Devises', category: 'Trésorerie', class: 5 },
  { code: '515', name: 'Trésor Public / CCP', category: 'Trésorerie', class: 5 },
  { code: '53', name: 'Caisse', category: 'Trésorerie', class: 5, isRoot: true },
  { code: '531', name: 'Caisse Principale', category: 'Trésorerie', class: 5 },
  ...
  { code: '631', name: 'Rémunérations du personnel', category: 'Charges', class: 6 },
  { code: '635', name: 'Cotisations aux organismes sociaux', category: 'Charges', class: 6 },
  ...
  { code: '7001', name: 'Ventes - Alimentation', category: 'Produits', class: 7 },
  { code: '7002', name: 'Ventes - Boissons', category: 'Produits', class: 7 },
  { code: '701', name: 'Ventes de produits finis', category: 'Produits', class: 7 },
  { code: '704', name: 'Travaux édifiés (BTP)', category: 'Produits', class: 7 },
  { code: '706', name: 'Prestations de services', category: 'Produits', class: 7 },
  { code: '75', name: 'Autres produits opérationnels', category: 'Produits', class: 7, isRoot: true },
  { code: '76', name: 'Produits financiers', category: 'Produits', class: 7, isRoot: true },
];
